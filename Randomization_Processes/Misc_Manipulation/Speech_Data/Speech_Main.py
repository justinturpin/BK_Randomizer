...
from Randomization_Processes.Dicts_And_Lists.World_Order_Warps import (
    bottles_moves_camera_dict,
)
from Randomization_Processes.Misc_Manipulation.Speech_Data.Speech_File import (
    Speech_File_Class,
)
...
class Speech_Manipulation_Class:
    ...
    def __init__(self, grandmaster, seed_val):
        ...
        self.paths = grandmaster.paths
        self._detailed_brentilda_hints = (
            self._grandmaster.brentilda_hints_var.get()
    ...
    def _brentilda_intro(self):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E3A0")
        brentilda_text._replace_line("48454c4c4f205448455245", f"HELLO! I'M BRENTILDA!")
        brentilda_text._replace_line(
            "49204b4e4f5720414c4c",
            f"I KNOW GRUNTY'S RANDOMIZER SPELL AND I'LL TELL YOU 3 HINTS FOR THE SEED EVERY TIME YOU FIND ME.",
        )
        brentilda_text._replace_line(
            "52454d454d424552205448454d", f"I'LL ALSO WARP YOU PAST HER FURNACE FUN."
        )
    ...
    def _click_clock_wood_item_count(self, world_object_list, object_name):
        ...
        if object_name == "Bottles":
                ...
                for setup_file in world_object._setup_list:
                    for bottles_search in bottles_moves_camera_dict:
                        if setup_file._does_string_exist(bottles_search):
                            move_list.append(
                                bottles_moves_camera_dict[bottles_search]["Move_Name"]
                            )
            return move_list
            ...
            if self._grandmaster.remove_floating_jiggies_var.get() == 1:
                return (
                    self._spawned_count["Click Clock Wood"]["Jiggies"],
                    self._spawned_count["Click Clock Wood"]["Empty Honeycombs"],
                )
            if self._grandmaster.flagged_object_var.get() in [
                "No Shuffle",
                "Shuffle (World)",
            ]:
                return 10, 2
                ...
                honeycomb_count = (
                    len(set(honeycomb_list))
                    + self._spawned_count["Click Clock Wood"]["Empty Honeycombs"]
                )
                if self._grandmaster.flagged_object_abnormalities_var.get() == 0:
                    jiggy_count += self._spawned_count["Click Clock Wood"][
                        "Abnormal Jiggies"
                    ]
                    honeycomb_count += self._spawned_count["Click Clock Wood"][
                        "Abnormal Empty Honeycombs"
                    ]
    ...
    def _item_count(self, world_object, object_name):
        ...
        if object_name == "Bottles":
            ...
            if self._grandmaster.remove_floating_jiggies_var.get() == 1:
                return (
                    self._spawned_count[world_object._world_name]["Jiggies"],
                    self._spawned_count[world_object._world_name]["Empty Honeycombs"],
                )
            if self._grandmaster.flagged_object_var.get() in [
                "No Shuffle",
                "Shuffle (World)",
                ...
                honeycomb_count += self._spawned_count[world_object._world_name][
                    "Empty Honeycombs"
                ]
                if self._grandmaster.flagged_object_abnormalities_var.get() == 0:
                    jiggy_count += self._spawned_count[world_object._world_name][
                        "Abnormal Jiggies"
                    ]
                    honeycomb_count += self._spawned_count[world_object._world_name][
                        "Abnormal Empty Honeycombs"
    ...
    def _brentilda_1_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E2B0")
        ...
        if self._detailed_brentilda_hints:
            ...
            brentilda_text._replace_line(
                "4752554e5459", f"WORLD 1, {world_name}, HAS {move_string}! ~"
            )
        else:
            brentilda_text._replace_line(
                "4752554e5459",
                f"WORLD 1, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_1_2(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E2B8")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "53484520414c534f", f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~"
            )
        else:
            brentilda_text._replace_line(
                "53484520414c534f",
                f"{(world_object._world_name).upper()} HAS {note_count} NOTES! ~",
            )
    ...
    def _brentilda_1_3(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E2C0")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "414e4420534845",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
            )
        else:
            brentilda_text._replace_line(
                "414e4420534845",
                f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
            )
    ...
    def _brentilda_2_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E2C8")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "55474c59204752554e5459", f"WORLD 2, {world_name}, HAS {move_string}! ~"
            )
        else:
            brentilda_text._replace_line(
                "55474c59204752554e5459",
                f"WORLD 2, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_2_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E2D0")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "4920414c534f", f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~"
            )
        else:
            brentilda_text._replace_line(
                "4920414c534f",
    ...
    def _brentilda_2_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E2D8")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "414e4420544845",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
    ...
    def _brentilda_3_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E388")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "4752554e5459205745415253",
                f"WORLD 3, {world_name}, HAS {move_string}! ~",
            )
        else:
            brentilda_text._replace_line(
                "4752554e5459205745415253",
                f"WORLD 3, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_3_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E390")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "534845275320414c534f", f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~"
            )
        else:
            brentilda_text._replace_line(
                "534845275320414c534f",
                f"{(world_object._world_name).upper()} HAS {note_count} NOTES! ~",
            )
    ...
    def _brentilda_3_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E398")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "4d5920534953544552",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
    ...
    def _brentilda_4_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E340")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "4d59204c415a59", f"WORLD 4, {world_name}, HAS {move_string}! ~"
            )
        else:
            brentilda_text._replace_line(
                "4d59204c415a59",
                f"WORLD 4, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_4_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E348")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "544845204f4e4c59205448494e47",
                f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~",
            )
        else:
            brentilda_text._replace_line(
                "544845204f4e4c59205448494e47",
    ...
    def _brentilda_4_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E350")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "534845204f4654454e20424f41535453",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
            )
        else:
            brentilda_text._replace_line(
    ...
    def _brentilda_5_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E2E0")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "4d5920464154", f"WORLD 5, {world_name}, HAS {move_string}! ~"
            )
        else:
            brentilda_text._replace_line(
                "4d5920464154",
                f"WORLD 5, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_5_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E2E8")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "414c54484f554748", f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~"
            )
        else:
            brentilda_text._replace_line(
                "414c54484f554748",
    ...
    def _brentilda_5_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E2F0")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "594f5520574f4e2754",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
    ...
    def _brentilda_6_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E328")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "4752554e54592753", f"WORLD 6, {world_name}, HAS {move_string}! ~"
            )
        else:
            brentilda_text._replace_line(
                "4752554e54592753",
                f"WORLD 6, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_6_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E330")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "5748454e2052454c4158494e47",
                f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~",
            )
        else:
            brentilda_text._replace_line(
    ...
    def _brentilda_6_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E338")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "5748494c452053495050494e47",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
            )
        else:
            brentilda_text._replace_line(
    ...
    def _brentilda_7_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E2F8")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "5448452044495347555354494e47",
                f"WORLD 7, {world_name}, HAS {move_string}! ~",
            )
        else:
            brentilda_text._replace_line(
                "5448452044495347555354494e47",
                f"WORLD 7, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_7_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E300")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "5448454e20534845", f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~"
            )
        else:
            brentilda_text._replace_line(
                "5448454e20534845",
    ...
    def _brentilda_7_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E308")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "5741525442414753",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
    ...
    def _brentilda_8_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E310")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "5245564f4c54494e47", f"WORLD 8, {world_name}, HAS {move_string}! ~"
            )
        else:
            brentilda_text._replace_line(
                "5245564f4c54494e47",
                f"WORLD 8, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_8_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E318")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "53484520414c534f", f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~"
            )
    ...
    def _brentilda_8_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E320")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "414e4420594f552744",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
    ...
    def _brentilda_9_1(self, world_object):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E370")
        move_list = self._item_count(world_object, "Bottles")
        if isinstance(world_object, list):
            world_name = "CLICK CLOCK WOOD"
        else:
        ...
        if self._detailed_brentilda_hints:
            move_string = self._generate_brentilda_move_string(move_list)
            brentilda_text._replace_line(
                "44494420594f55", f"WORLD 9, {world_name}, HAS {move_string}! ~"
            )
        else:
            brentilda_text._replace_line(
                "44494420594f55",
                f"WORLD 9, {world_name} HAS {len(move_list)} NEW MOVES! ~",
            )
    ...
    def _brentilda_9_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File_Class(self.paths, "E378")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "4927564520414c534f", f"CLICK CLOCK WOOD HAS {note_count} NOTES! ~"
            )
        else:
            brentilda_text._replace_line(
                "4927564520414c534f",
    ...
    def _brentilda_9_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E380")
        if isinstance(world_object, list):
            brentilda_text._replace_line(
                "5348452753205245414c4c59",
                f"CLICK CLOCK WOOD HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
            )
        else:
            brentilda_text._replace_line(
    ...
    def _brentilda_10_1(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E358")
        brentilda_text._replace_line(
            "47525545534f4d45",
            f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
        )
    ...
    def _brentilda_10_2(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File_Class(self.paths, "E360")
        brentilda_text._replace_line(
            "5448495320504f4f5220475559",
            f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES AND {honeycomb_count} EMPTY HONEYCOMBS! ~",
        )
    ...
    def _brentilda_10_3(self):
        ...
        brentilda_text = Speech_File_Class(self.paths, "E368")
        last_brentilda_list = [
    ...
    def _intro_cutscene_1(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D150")
        intro_cutscene_text._replace_line(
            "44494e47504f54", "DINGPOT, DINGPOT THAT I CLAIM,"
        )
        intro_cutscene_text._replace_line(
            "57484f20495320544845", "WHO HAS THE TOUGHEST GAME?"
        )
        intro_cutscene_text._replace_line(
            "5748592049542753", "WHY IT'S GRUNTY'S ANY DAY,"
        )
        intro_cutscene_text._replace_line(
            "534845205245414c4c59", "HER LEVELS TAKE PLAYERS' LIVES AWAY...COUGH!"
        )
        intro_cutscene_text._replace_line(
            "59455320594f55275245", "YES YOU'RE RIGHT, I'M RATHER PROUD,"
        )
        intro_cutscene_text._replace_line(
            "4d59204c4f4f4b53", "MY WORLDS STAND ME OUT FROM THE CROWD!"
        )
    ...
    def _intro_cutscene_2(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D158")
        intro_cutscene_text._replace_line(
            "4552522e2e2e425554", "ERR...BUT MOST HAVE BEATEN IT..."
        )
        intro_cutscene_text._replace_line(
            "57484154204427594f55", "WHAT D'YOU MEAN, THIS CANNOT BE,"
        )
        intro_cutscene_text._replace_line(
            "54484552452753204e4f", "THE LAST TWO WORLDS AREN'T EASY!"
        )
        intro_cutscene_text._replace_line(
            "5748592c204954275320544f4f5459", "PLAYERS MEMORIZED EVERY SPOT,"
        )
        intro_cutscene_text._replace_line(
            "53484527532054484520505245545449455354", "THEY MOVE QUICKLY IN TALON TROT."
        )
        intro_cutscene_text._replace_line(
            "4e4f204e4f204e4f", "NO NO NO YOU MUST BE MAD,"
        )
        intro_cutscene_text._replace_line(
            "4e4943455220424541555459", "HARDER GAMEPLAY CAN'T BE HAD!"
        )
        intro_cutscene_text._replace_line(
            "554e464f5254554e4154454c59", "I THINK YOU'LL COME TO KNOW,"
        )
        intro_cutscene_text._replace_line(
            "4954275320544f4f5459", "THERE'S A ROUTE PLAYERS LIKE TO GO."
        )
    ...
    def _intro_cutscene_4(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D168")
        #         intro_cutscene_text._replace_line("4849205448455245", "")
        intro_cutscene_text._replace_line(
            "5748454e204d59", "I'M GOING TO WATCH MY BROTHER SPEEDRUN THE GAME HAHA!"
        )
    ...
    def _intro_cutscene_5(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D170")
        intro_cutscene_text._replace_line(
            "57414b45205550", "WAKE UP, I WANT TO GET UNDER 2 HOURS!"
        )
    ...
    def _intro_cutscene_6(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D178")
        intro_cutscene_text._replace_line(
            "494620544f4f5459", "IF PLAYERS THINK THEY KNOW THE GAME WELL,"
        )
        intro_cutscene_text._replace_line(
            "49274c4c20535445414c", "I'LL CHANGE THE GAME WITH MY RANDOMIZE SPELL!"
        )
    ...
    def _intro_cutscene_7(self):
        ...
        #         intro_cutscene_text = Speech_File_Class(self.paths, "D180")
    ...
    def _intro_cutscene_8(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D188")
        intro_cutscene_text._replace_line(
            "4920444f4e2754", "OH NO... THAT'S A BAD SEED!"
        )
    ...
    def _intro_cutscene_9(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D190")
        intro_cutscene_text._replace_line(
            "434f4d4520544f204d45", "ONCE I MOVE SOME THINGS AROUND,"
        )
        intro_cutscene_text._replace_line(
            "594f55274c4c20534f4f4e", "NO COLLECTABLES WILL BE FOUND!"
        )
    ...
    def _intro_cutscene_10(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D198")
        intro_cutscene_text._replace_line(
            "4c4554204d4520474f", "PUT THAT BACK, YOU UGLY OLD HAG!"
        )
    ...
    def _intro_cutscene_11(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D1A0")
        intro_cutscene_text._replace_line(
            "444f4e27542053435241544348", "I'LL PUT THIS HERE, I'LL PUT THAT THERE,"
        )
        intro_cutscene_text._replace_line(
            "594f55274c4c20534f4f4e", "NOW THERE ARE NEW THINGS EVERYWHERE!"
        )
    ...
    def _intro_cutscene_12(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D1A8")
        intro_cutscene_text._replace_line(
            "4f48204e4f2c", "I CAN'T TELL, IS THIS WORLD RECORD PACE?"
        )
    ...
    def _intro_cutscene_13(self):
        ...
        #         intro_cutscene_text = Speech_File_Class(self.paths, "D1B0")
    ...
    def _intro_cutscene_14(self):
        ...
        #         intro_cutscene_text = Speech_File_Class(self.paths, "")
        #         intro_cutscene_text._replace_line("", "")
        pass
    ...
    def _enter_lair_cutscene(self):
        ...
        # TOOTY: BANJO............HELP!
        intro_cutscene_text = Speech_File_Class(self.paths, "D1C8")
        intro_cutscene_text._replace_line(
            "544849532046494e45", "WITH EVERYTHING JUMBLED, I'LL HAVE MORE TIME,"
        )
        intro_cutscene_text._replace_line(
            "57494c4c204d414b45", "TO STEAL YOUR BEAUTY AND BE AT MY PRIME!"
        )
        intro_cutscene_text._replace_line(
            "4c4554204d4520474f", "MY BROTHER BEAT YOU BEFORE,"
        )
        intro_cutscene_text._replace_line("414e44204b49434b", "HE WILL BEAT YOU AGAIN!")
        intro_cutscene_text._replace_line(
            "52455343554520594f55", "THERE IS NO GUIDE FOR RNG,"
        )
        intro_cutscene_text._replace_line(
            "54484552452753204d414e59", "I DOUBT HE EVEN OPENED THE README!"
        )
        intro_cutscene_text._replace_line(
            "4855525259204b4c554e474f2c", "NOW HURRY KLUNGO, IT'S TIME TO START,"
        )
        intro_cutscene_text._replace_line(
            "49274d205449524544", "I WANT TO LOOK LIKE ALL MY FAN ART!"
        )
        intro_cutscene_text._replace_line(
            "5945535353204d49535353545245535353", "YESSS MISSSTRESSS GRUNTY!"
        )
    ...
    def _game_over_cutscene(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D1D0")
        intro_cutscene_text._replace_line(
            "42414E4A4F27532047414D4520454E44", "THE PLAYER IS NOW REGRETTING,"
        )
        intro_cutscene_text._replace_line(
            "5455524E2049542055502049204E4545", "TURNING ON A HARDER SETTING!"
        )
        # 0xD1D8 - 5CAF98
        # KLUNGO: YESSS YOUR GRUNTYSSSHIP, TRANSSSFORMATION SSSOON BE COMPLETE...
        intro_cutscene_text = Speech_File_Class(self.paths, "D1D8")
        intro_cutscene_text._replace_line(
            "594553535320594F5552204752554E54",
            "GEE GEE EASSSY, AMAZZZING CHESSST AHEAD...",
        )
        # 0xD1E0 - 5CAFE8
        # KLUNGO: BEAR AND BIRD FINISSSHED, GRUNTY WINSSS!
        # TOOTY: ýhHELP ýhME ýhBANJO, ýhI ýhFEEL ýhALL ýhFUNNY...ýl
        intro_cutscene_text = Speech_File_Class(self.paths, "D1E0")
        intro_cutscene_text._replace_line(
            "4245415220414E442042495244204649", "TRANSSSFORMATION ISSS SSSUCCESSSSFUL!"
        )
        intro_cutscene_text._replace_line(
            "FD6848454C5020FD684D4520FD684241",
            "ýhOH ýhNO! ýhTHERE'S ýhA ýhYUM-YUM ýhIN ýhHERE!ýl",
        )
        # 0xD1E8 - 5CB058
        # GRUNTY: LOOK AT GRUNTY SHE'S A BEAUTY,
        # GRUNTY: I'M MUCH PRETTIER THAN TOOTY!
        # KLUNGO: OH YOU ARE MISSSTRESSS!
        intro_cutscene_text = Speech_File_Class(self.paths, "D1E8")
        intro_cutscene_text._replace_line(
            "4C4F4F4B204154204752554E54592053", "NOW THAT I AM SO MUCH HOTTER,"
        )
        intro_cutscene_text._replace_line(
            "49274D204D5543482050524554544945", "I CAN SELL MY CAULDRON WATER!"
        )
        intro_cutscene_text._replace_line(
            "4F4820594F5520415245204D49535353", "YASSS MISSSTRESSS! SSSLAY!"
        )
        # 0xD230 - 5CB2C8
        # MUMBO: GRUNTY NICE, COME BACK TO MUMBO'S SKULL, YES?
        intro_cutscene_text = Speech_File_Class(self.paths, "D230")
        intro_cutscene_text._replace_line(
            "4752554E5459204E4943452C20434F4D", "MOMMY? SORRY, MOMMY? SORRY, MOMMY?..."
        )
        # 0xD200 - 5CB100
        # TOOTY: BANJO! YOUR SISTER WANTS A WORD WITH YOU.........
        # TOOTY: NOW!
        intro_cutscene_text = Speech_File_Class(self.paths, "D200")
        intro_cutscene_text._replace_line(
            "42414E4A4F2120594F55522053495354",
            "BANJO! YOUR SISTER HAS TWO WORDS FOR YOU...",
        )
    ...
    def _bottles_opened_first_world(self, world_object):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA88")
        if isinstance(world_object, list):
            intro_cutscene_text._replace_line(
                "54484154275320495421205448452050",
                f"THAT'S IT! THE PICTURE'S COMPLETE AND THE DOOR TO CLICK CLOCK WOOD IS OPEN!",
            )
        else:
            intro_cutscene_text._replace_line(
                "54484154275320495421205448452050",
                f"THAT'S IT! THE PICTURE'S COMPLETE AND THE DOOR TO {(world_object._world_name).upper()} IS OPEN!",
            )
    ...
    def _bottles_this_is_first_world(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA90")
        intro_cutscene_text._replace_line(
            "54484953204953205448452046495253",
            f"IS THIS YOUR FIRST TIME PLAYING BANJO-KAZOOIE? GO GET A JIGGY, 4HEAD!",
        )
    ...
    def _bottles_this_is_first_puzzle(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA98")
        intro_cutscene_text._replace_line(
            "54484953204953205448452046495253",
            f"IS IT REALLY MUMBO'S MOUNTAIN? MAYBE THE PICTURES SHOULD BE UPDATED...",
        )
    ...
    def _bottles_50_notes(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA38")
        intro_cutscene_text._replace_line(
            "59495050454521", "REMEMBER TO STAY HYDRATED!"
        )
    ...
    def _bottles_slippery_slope(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "B900")
        intro_cutscene_text._replace_line(
            "5448494E475320412042495420534C49", "LMAO CAUGHT YOU SLIPPIN' IN 4K!"
        )
    ...
    def _bottles_enter_mm_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D9D8")
        intro_cutscene_text._replace_line(
            "544845524520415245", "BEAR AND BIRD FIND MOLE AND LEARN MOVES!"
        )
    ...
    def _bottles_learned_mm_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "B908")
    ...
    def _bottles_leaving_mm_without_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA08")
        intro_cutscene_text._replace_line(
            "574149542120594F55204449444E2754",
            "WHAT'S THE MATTER? DON'T LIKE BACKTRACKING? GUESS YOU WON'T LIKE TOOIE...",
        )
    ...
    def _bottles_enter_ttc_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D9E0")
        intro_cutscene_text._replace_line(
            "41484f5920544845524521", "REMEMBER CAP'N BLACKEYE? ME NEITHER!"
        )
    ...
    def _bottles_learned_ttc_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "AFD0")
        intro_cutscene_text._replace_line(
            "4e49434520474f494e47",
            "THE REAL LOOT BE THE SCALLYWAGS WE MADE ALONG THE WAY!",
        )
    ...
    def _bottles_leaving_ttc_without_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA10")
        intro_cutscene_text._replace_line(
            "48455921205448455245275320415420",
            "THE CAMERAS GET FUNKY WHEN YOU LEARN A MOVE NOT FROM THAT LEVEL!",
        )
    ...
    def _bottles_enter_cc_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D9E8")
        intro_cutscene_text._replace_line(
            "4a55535420544845", "WHAT IS CLANKER ANYWAY? A SHARK? A WHALE?"
        )
    ...
    def _bottles_learned_cc_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "C850")
        intro_cutscene_text._replace_line(
            "594f55275645", "IS ANYONE REALLY FREE WHEN CHAINED TO SOCIETY?"
        )
    ...
    def _bottles_leaving_cc_without_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA18")
        intro_cutscene_text._replace_line(
            "594F55204449444E27542053504C4153", "BABY SHARK DO DO DO DO DO DO!"
        )
    ...
    def _bottles_enter_bgs_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D9F0")
        intro_cutscene_text._replace_line(
            "4b45455020594f5552", "WHAT ARE YEW DOIN' IN MY SWAMP?!"
        )
    ...
    def _bottles_learned_bgs_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "C2E8")
        intro_cutscene_text._replace_line(
            "47524541542c", "IT SMELLS LIKE A VIDEO GAME CHAMPIONSHIP HERE..."
        )
    ...
    def _bottles_leaving_bgs_without_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA20")
        intro_cutscene_text._replace_line(
            "57414445204241434B20494E20544845",
    ...
    def _bottles_enter_fp_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "D9F8")
        intro_cutscene_text._replace_line(
            "544845205045414b",
    ...
    def _bottles_learned_fp_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "BFE8")
    ...
    def _bottles_leaving_fp_without_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA28")
        intro_cutscene_text._replace_line(
            "484F4C442049542C2042414E4A4F2C20",
            "CHRISTMAS IS OVER, TIME FOR VALENTINES DAY DECORATIONS!",
        )
    ...
    def _bottles_enter_gv_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA00")
        intro_cutscene_text._replace_line(
            "594f55274c4c",
    ...
    def _bottles_learned_gv_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "B2C8")
    ...
    def _bottles_leaving_gv_without_moves(self):
        ...
        intro_cutscene_text = Speech_File_Class(self.paths, "DA30")
        intro_cutscene_text._replace_line(
            "444F4E27542044455345525420544845",
            "THERE ARE SOME REALLY COOL IMAGES ON THE WALLS IN THE MAZE!",
        )
    ...
    def _bottles_introduction_text(self):
        ...
        bottles_intro_text = Speech_File_Class(self.paths, "CE30")
        bottles_intro_text._replace_line(
            "4c495354454e20555021", "WELCOME TO THE RANDO, PRESS LRB TO SKIP MY TEXT."
        )
        bottles_intro_text._replace_line(
            "49274d2042414e4a4f2c", "NOT THIS TIME, BOTTLES."
        )
        bottles_intro_text._replace_line("535552452049532041", "HUH?")
        bottles_intro_text._replace_line(
            "424554544552205448414e", "WE CARE ABOUT YOUR DUMB BUTT."
        )
        bottles_intro_text._replace_line(
            "574841542057415320414c4c",
            "AND THAT'S COMING FROM LOUD-MOUTH KAZOOIE HAHA!",
        )
        bottles_intro_text._replace_line(
            "5448452055474c59205749544348",
            "AW MAN, THAT REALLY MEANS A LOT... SNIFFLES...",
        )
        bottles_intro_text._replace_line("43414c4d20444f574e", "WE GOTCHU, FOUR-EYES.")
        bottles_intro_text._replace_line(
            "53484520464c4557205550", "IT'S JUST HARD TO TALK ABOUT."
        )
        bottles_intro_text._replace_line(
            "49542753205245414c4c59", "ANYWAY, BACK TO THE GAME..."
        )

    def _modify_bottles_unskippable_text(
        self,
        final_note_option,
        final_note_score,
        final_puzzle_option,
        ...
        bottles_unskippable_text = Speech_File_Class(self.paths, "CF90")
    ...
    def _shorten_bottles_secret_game_text(self):
        ...
        secret_game_text = Speech_File_Class(self.paths, "CF98")
        secret_game_text._replace_line(
            "4f482e2e2e49274d", "GO COLLECT THE SANDCASTLE JIGGY FIRST."
        )
        secret_game_text._replace_line(
            "4e4f21204f4e4c59", "JUST GET THE JIGGY FIRST, BIRD BRAIN!"
        )
        secret_game_text._replace_line(
            "43274d4f4e204b415a4f4f4945", "C'MON KAZOOIE, LET'S COME BACK LATER."
        )
    ...
    def _furnace_fun_questions_main(self, empty=True):
        ...
        if empty:
            furnace_fun_json = read_json(
                f"{self._file_dir}Randomization_Processes/Misc_Manipulation/Speech_Data/Furnace_Fun_Empty.json"
            )
        else:
            furnace_fun_json = read_json(
                f"{self._file_dir}Randomization_Processes/Misc_Manipulation/Speech_Data/Furnace_Fun_Custom.json"
            )
        for pointer_index_str in furnace_fun_json:
            furnace_fun_text = Speech_File_Class(self.paths, pointer_index_str[2:])
            furnace_fun_text._furnace_fun_question_format(
                furnace_fun_json[pointer_index_str]["Question_Part_1"],
    ...
    def _gruntilda_lair_speech_1(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAC8")
    ...
    def _gruntilda_lair_speech_2(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAD0")
    ...
    def _gruntilda_lair_speech_3(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAD8")
    ...
    def _gruntilda_lair_speech_4(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAE0")
    ...
    def _gruntilda_lair_speech_5(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAE8")
    ...
    def _gruntilda_lair_speech_6(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAF0")
    ...
    def _gruntilda_lair_speech_7(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAF8")
    ...
    def _gruntilda_lair_speech_8(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB00")
    ...
    def _gruntilda_lair_speech_9(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB08")
    ...
    def _gruntilda_lair_speech_10(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB10")
    ...
    def _gruntilda_lair_speech_11(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB18")
    ...
    def _gruntilda_lair_speech_12(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB20")
    ...
    def _gruntilda_lair_speech_13(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB28")
    ...
    def _gruntilda_lair_speech_14(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB30")
    ...
    def _gruntilda_lair_speech_15(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB38")
    ...
    def _gruntilda_lair_speech_16(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB40")
    ...
    def _gruntilda_lair_speech_17(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB48")
    ...
    def _gruntilda_lair_speech_18(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB50")
    ...
    def _gruntilda_lair_speech_19(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB58")
    ...
    def _gruntilda_lair_speech_20(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB60")
    ...
    def _gruntilda_lair_speech_21(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB68")
    ...
    def _gruntilda_lair_speech_22(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB70")
    ...
    def _gruntilda_lair_speech_23(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB78")
    ...
    def _gruntilda_lair_speech_24(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB80")
    ...
    def _gruntilda_lair_speech_25(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB88")
    ...
    def _gruntilda_lair_speech_26(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB90")
    ...
    def _gruntilda_lair_speech_27(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DB98")
    ...
    def _gruntilda_lair_speech_28(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DBA0")
    ...
    def _gruntilda_lair_speech_29(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DBA8")
    ...
    def _gruntilda_lair_speech_30(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DBB0")
    ...
    def _gruntilda_lair_speech_31(self, message1, message2):
        ...
        grunty_text = Speech_File_Class(self.paths, "DBB8")
    ...
    def _gruntilda_lair_speech_32(self):
        ...
        grunty_text = Speech_File_Class(self.paths, "")
        grunty_text._replace_line(
            "", "THERE HE IS, THE FUN BEGINS, WITH THESE SETTINGS LET'S SEE WHO WINS!"
        )
    ...
    def _gruntilda_lair_speech_34(self):
        ...
        grunty_text._replace_line(
            "",
            "YOU GOT SOME NOTES, THOUGHT YOU WERE STOCKED, BUT UNTIL THEN, GET SOFTLOCKED!",
        )
    ...
    def _gruntilda_lair_speech_36(self):
        ...
        grunty_text = Speech_File_Class(self.paths, "")
        grunty_text._replace_line(
            "", "WORLDS ARE NOT THE ONLY CHANGE, IN MY LAIR, THINGS GET STRANGE!"
        )
    ...
    def _gruntilda_lair_speech_41(self):
        ...
        grunty_text = Speech_File_Class(self.paths, "")
        grunty_text._replace_line(
            "", "GET ONE LAST LOOK AT MY PIC! IN A MOMENT, I WILL LOOK SLICK!"
        )
    ...
    def _bk_first_death_gruntilda(self):
        ...
        grunty_text = Speech_File_Class(self.paths, "DAA0")
        grunty_text._replace_line(
            "5748415427532057524F4E472042414E", "TRYING TO GET THE GAME OVER SCREEN?!"
        )
        grunty_text._replace_line(
            "4C4554204D45204B4E4F57205748454E", "YOU ARE LIKE A PERVERTED TEEN!"
        )
    ...
    def _raised_maximum_blue_eggs_speech(self):
        ...
        grunty_text = Speech_File_Class(self.paths, "DBD8")
        grunty_text._replace_line(
            "323030204547475320415245204E4F57", "YOU CAN NOW CARRY MORE EGGS!"
        )
    ...
    def _raised_maximum_red_feathers_speech(self):
        ...
        grunty_text = Speech_File_Class(self.paths, "DBE0")
        grunty_text._replace_line(
            "4245415220414E442042495244204745", "YOU CAN NOW CARRY MORE RED FEATHERS!"
        )
    ...
    def _raised_maximum_gold_feathers_speech(self):
        ...
        grunty_text = Speech_File_Class(self.paths, "DBE8")
        grunty_text._replace_line(
            "323020474F4C44204645415448455253", "YOU CAN NOW CARRY MORE GOLD FEATHERS!"
        )
