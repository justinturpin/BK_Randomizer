...
class BK_Model_Class(Generic_Models.Model):
    ...
    def _only_low_poly_bk_model(self) -> None:
        """
        Copys the low poly model for Banjo-Kazooie and replaces the high poly model
        """
        shutil.copy(
            self._paths.decompressed_path("7900"),
            self._paths.decompressed_path("7908"),
        )
        with self._paths.rom_path.open("r+b") as rand_rom:
