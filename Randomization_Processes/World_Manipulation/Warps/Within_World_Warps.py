...
class Warp:
    ...
    def __init__(
        ...
        warps_to,
        warps_from,
        can_exit_from_room=63,
        can_enter_warp_zone=63,
        keep_in_same_setup=False,
        keep_in_same_world=False,
        warp_search_strings=[],
    ):
        ...
        self.warps_name = (
            debug_name  # This is the name of the warp that got replaced by this one
        )
...
Levels = {
    "Mumbo's Mountain": [
        Warp(
            debug_name="MM Mumbo's Skull (Going Outside)",
            object_id=0x17,
            warps_to=0x100,
            warps_from=0x101,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MM Mumbo's Skull (Coming Inside)",
            object_id=0x16,
            warps_to=0x101,
            warps_from=0x100,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MM Ticker's Tower (Going Outside - Lower)",
            object_id=0x19,
            warps_to=0x100,
            warps_from=0x102,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MM Ticker's Tower (Coming Inside - Lower)",
            object_id=0x18,
            warps_to=0x102,
            warps_from=0x100,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MM Ticker's Tower (Going Outside - Upper)",
            object_id=0x1B,
            warps_to=0x103,
            warps_from=0x102,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MM Ticker's Tower (Coming Inside - Upper)",
            object_id=0x1A,
            warps_to=0x102,
            warps_from=0x103,
            warp_search_strings=[
    ...
    "Treasure Trove Cove": [
        Warp(
            debug_name="TTC Nipper's Shell (Going Outside)",
            object_id=0x0B,
            warps_to=0x200,
            warps_from=0x201,
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC Nipper's Shell (Coming Inside)",
            object_id=0x47,
            warps_to=0x201,
            warps_from=0x200,
            can_enter_warp_zone=Warp.Banjo,
            keep_in_same_setup=True,
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC Sandcastle (Going Outside)",
            object_id=0x72,
            warps_to=0x200,
            warps_from=0x202,
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC Sandcastle (Coming Inside)",
            object_id=0x6B,
            warps_to=0x202,
            warps_from=0x200,
            keep_in_same_world=True,
            can_exit_from_room=(
                Warp.Banjo + Warp.Termite + Warp.Crocodile + Warp.Pumpkin
            ),
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC Salty Hippo (Going Outside - Top)",
            object_id=0x75,
            warps_to=0x200,
            warps_from=0x203,
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC Salty Hippo (Coming Inside - Top)",
            object_id=0x6E,
            warps_to=0x203,
            warps_from=0x200,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="TTC Salty Hippo (Going Outside - Side)",
            object_id=0x76,
            warps_to=0x200,
            warps_from=0x204,
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC Salty Hippo (Coming Inside - Side)",
            object_id=0x6F,
            warps_to=0x204,
            warps_from=0x200,
            can_enter_warp_zone=(
        ...
        Warp(
            debug_name="TTC To Top Of The Mountain",
            object_id=0x6D,
            warps_to=0x206,
            warps_from=0x205,
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC To Arch Under Alcove",
            object_id=0x6C,
            warps_to=0x205,
            warps_from=0x206,
            warp_search_strings=[
        ...
        Warp(
            debug_name="TTC To Lighthouse Upper",
            object_id=0x71,
            warps_to=0x207,
            warps_from=0x206,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="TTC To Lighthouse Lower",
            object_id=0x70,
            warps_to=0x206,
            warps_from=0x207,
            warp_search_strings=[
    ...
    "Clanker's Cavern": [
        Warp(
            debug_name="CC Left Gill To Outside",
            object_id=0x2F,
            warps_to=0x300,
            warps_from=0x301,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="CC Right Gill To Outside",
            object_id=0x30,
            warps_to=0x300,
            warps_from=0x301,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="CC Left Tooth To Outside",
            object_id=0x31,
            warps_to=0x300,
            warps_from=0x302,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="CC Right Tooth To Outside",
            object_id=0x32,
            warps_to=0x300,
            warps_from=0x303,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="CC Gold Feather Room (Coming Outside)",
            object_id=0x9B,
            warps_to=0x304,
            warps_from=0x301,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CC Gold Feather Room (Going Inside)",
            object_id=0x9E,
            warps_to=0x301,
            warps_from=0x304,
            can_enter_warp_zone=(Warp.Banjo + Warp.Bee),
            can_exit_from_room=Warp.Banjo,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CC Blowhole To Mouth",
            object_id=0x9D,
            warps_to=0x301,
            warps_from=0x305,
            can_exit_from_room=Warp.Banjo,
        ...
        Warp(
            debug_name="CC Blowhole To Belly",
            object_id=0x9C,
            warps_to=0x301,
            warps_from=0x305,
            can_exit_from_room=Warp.Banjo,
    ...
    "Bubblegloop Swamp": [
        Warp(
            debug_name="BGS Tanktup (Coming Outside)",
            object_id=0x68,
            warps_to=0x400,
            warps_from=0x401,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="BGS Tanktup (Going Inside)",
            object_id=0x46,
            warps_to=0x401,
            warps_from=0x400,
            keep_in_same_setup=True,
        ...
        Warp(
            debug_name="BGS Mumbo's Skull (Coming Outside)",
            object_id=0xA,
            warps_to=0x400,
            warps_from=0x402,
            can_enter_warp_zone=(
                Warp.Banjo + Warp.Termite + Warp.Walrus + Warp.Pumpkin + Warp.Bee
            ),
            warp_search_strings=[
        ...
        Warp(
            debug_name="BGS Mumbo's Skull (Going Inside)",
            object_id=0x9,
            warps_to=0x402,
            warps_from=0x400,
            can_enter_warp_zone=(
        ...
        Warp(
            debug_name="BGS Croc Left Nostril (Going Outside)",
            object_id=0x67,
            warps_to=0x400,
            warps_from=0x403,
            can_enter_warp_zone=Warp.Crocodile,
            can_exit_from_room=Warp.Crocodile,
            warp_search_strings=[
        ...
        Warp(
            debug_name="BGS Croc Left Nostril (Coming Inside)",
            object_id=0x6A,
            warps_to=0x403,
            warps_from=0x400,
            can_enter_warp_zone=Warp.Crocodile,
        ...
        Warp(
            debug_name="BGS Croc Right Nostril (Going Outside)",
            object_id=0x66,
            warps_to=0x400,
            warps_from=0x403,
            can_enter_warp_zone=Warp.Crocodile,
        ...
        Warp(
            debug_name="BGS Croc Right Nostril (Coming Inside)",
            object_id=0x69,
            warps_to=0x403,
            warps_from=0x400,
            can_enter_warp_zone=Warp.Crocodile,
    ...
    "Freezeezy Peak": [
        Warp(
            debug_name="FP Mumbo's Skull (Going Outside)",
            object_id=0x43,
            warps_to=0x500,
            warps_from=0x501,
            can_enter_warp_zone=(
                Warp.Banjo + Warp.Termite + Warp.Crocodile + Warp.Pumpkin + Warp.Bee
            ),
            warp_search_strings=[
        ...
        Warp(
            debug_name="FP Mumbo's Skull (Coming Inside)",
            object_id=0x40,
            warps_to=0x501,
            warps_from=0x500,
            can_enter_warp_zone=(
        ...
        Warp(
            debug_name="FP Boggy's Igloo (Going Outside)",
            object_id=0x44,
            warps_to=0x500,
            warps_from=0x502,
            warp_search_strings=[
        ...
        Warp(
            debug_name="FP Boggy's Igloo (Coming Inside)",
            object_id=0x41,
            warps_to=0x502,
            warps_from=0x500,
            warp_search_strings=[
        ...
        Warp(
            debug_name="FP Christmas Tree (Going Outside)",
            object_id=0x45,
            warps_to=0x500,
            warps_from=0x503,
            warp_search_strings=[
        ...
        Warp(
            debug_name="FP Christmas Tree (Coming Inside)",
            object_id=0x42,
            warps_to=0x503,
            warps_from=0x500,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="FP Wozza's Cave (Going Outside)",
            object_id=0xFC,
            warps_to=0x500,
            warps_from=0x504,
            can_exit_from_room=Warp.Walrus,
            warp_search_strings=[
        ...
        Warp(
            debug_name="FP Wozza's Cave (Coming Inside)",
            object_id=0xFD,
            warps_to=0x504,
            warps_from=0x500,
            can_enter_warp_zone=Warp.Walrus,
            warp_search_strings=[
    ...
    "Gobi's Valley": [
        Warp(
            debug_name="GV Jinxy (Going Outside)",
            object_id=0x6,
            warps_to=0x600,
            warps_from=0x601,
            warp_search_strings=[
        ...
        Warp(
            debug_name="GV Jinxy (Coming Inside)",
            object_id=0x5,
            warps_to=0x601,
            warps_from=0x600,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="GV Rupee (Going Outside)",
            object_id=0x64,
            warps_to=0x600,
            warps_from=0x602,
            warp_search_strings=[
        ...
        Warp(
            debug_name="GV Rupee (Coming Inside)",
            object_id=0x60,
            warps_to=0x602,
            warps_from=0x600,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="GV Matching Pyramid (Going Outside)",
            object_id=0x61,
            warps_to=0x600,
            warps_from=0x603,
            warp_search_strings=[
        ...
        Warp(
            debug_name="GV Matching Pyramid (Coming Inside)",
            object_id=0x5C,
            warps_to=0x603,
            warps_from=0x600,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="GV Water Pyramid (Going Outside)/Bottom",
            object_id=0x63,
            warps_to=0x600,
            warps_from=0x604,
            can_enter_warp_zone=(
        ...
        Warp(
            debug_name="GV Water Pyramid (Coming Inside)/Top",
            object_id=0x5E,
            warps_to=0x604,
            warps_from=0x600,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="GV Water Pyramid (Coming Inside)/Bottom",
            object_id=0x5F,
            warps_to=0x604,
            warps_from=0x600,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="GV King Sandybutt (Going Outside)/Front",
            object_id=0x62,
            warps_to=0x600,
            warps_from=0x605,
            warp_search_strings=[
        ...
        Warp(
            debug_name="GV King Sandybutt (Going Outside)/Back",
            object_id=0xDE,
            warps_to=0x600,
            warps_from=0x605,
            warp_search_strings=[
        ...
        Warp(
            debug_name="GV King Sandybutt (Coming Inside)/Front",
            object_id=0x5D,
            warps_to=0x605,
            warps_from=0x600,
            keep_in_same_setup=True,
    ...
    "Mad Monster Mansion": [
        Warp(
            debug_name="MMM Dining Room (Going Outside)",
            object_id=0x88,
            warps_to=0x700,
            warps_from=0x701,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="MMM Dining Room (Coming Inside)/Front",
            object_id=0x79,
            warps_to=0x701,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Dining Room (Coming Inside)/Chimney",
            object_id=0x7A,
            warps_to=0x701,
            warps_from=0x700,
            can_enter_warp_zone=(Warp.Banjo + Warp.Bee),
        ...
        Warp(
            debug_name="MMM First Floor 1 (Red Feather Room) (Going Outside)",
            object_id=0x91,
            warps_to=0x700,
            warps_from=0x702,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM First Floor 1 (Red Feather Room) (Coming Inside)",
            object_id=0x82,
            warps_to=0x702,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM First Floor 2 (Blue Egg Room) (Going Outside)",
            object_id=0x92,
            warps_to=0x700,
            warps_from=0x703,
            can_enter_warp_zone=Warp.Banjo,
        ...
        # Can't Find Warp?
        Warp(
            debug_name="MMM First Floor 2 (Blue Egg Room) (Coming Inside)",
            object_id=0x83,
            warps_to=0x703,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Second Floor 1 (Empty Honeycomb Room) (Going Outside)",
            object_id=0x94,
            warps_to=0x700,
            warps_from=0x704,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Second Floor 1 (Empty Honeycomb Room) (Coming Inside)",
            object_id=0x87,
            warps_to=0x704,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Second Floor 2 (Bathroom) (Going Outside)",
            object_id=0x93,
            warps_to=0x700,
            warps_from=0x705,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Second Floor 2 (Bathroom) (Coming Inside)",
            object_id=0x87,
            warps_to=0x705,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Third Floor 1 (Bedroom) (Going Outside)",
            object_id=0x95,
            warps_to=0x700,
            warps_from=0x706,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Third Floor 1 (Bedroom) (Coming Inside)",
            object_id=0x86,
            warps_to=0x706,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Third Floor 2 (Note Room) (Going Outside)",
            object_id=0x96,
            warps_to=0x700,
            warps_from=0x707,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Third Floor 2 (Note Room) (Coming Inside)",
            object_id=0x84,
            warps_to=0x707,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Well - Top/Outside",
            object_id=0x8A,
            warps_to=0x700,
            warps_from=0x708,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Well - Top/Inside",
            object_id=0x7B,
            warps_to=0x708,
            warps_from=0x700,
            can_exit_from_room=(Warp.Banjo + Warp.Bee + Warp.Pumpkin),
            warp_search_strings=[
        ...
        # Can't Find Warp?
        Warp(
            debug_name="MMM Tumblar's Shed (Going Outside)",
            object_id=0x8B,
            warps_to=0x700,
            warps_from=0x709,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Tumblar's Shed (Coming Inside)",
            object_id=0x7C,
            warps_to=0x709,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="MMM Church (Going Outside)",
            object_id=0x8C,
            warps_to=0x700,
            warps_from=0x70A,
            warp_search_strings=[
        ...
        #             ]),
        Warp(
            debug_name="MMM Church Secret Room (Going Outside)",
            object_id=0x8D,
            warps_to=0x700,
            warps_from=0x70B,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Church Secret Room (Coming Inside)",
            object_id=0x7E,
            warps_to=0x70B,
            warps_from=0x700,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Cellar (Going Outside)",
            object_id=0x90,
            warps_to=0x700,
            warps_from=0x70C,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Cellar (Coming Inside)",
            object_id=0x81,
            warps_to=0x70C,
            warps_from=0x700,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="MMM Church Tower Lower To Upper",
            object_id=0x97,
            warps_to=0x700,
            warps_from=0x70D,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Church Tower Upper To Lower",
            object_id=0x98,
            warps_to=0x70D,
            warps_from=0x700,
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Mumbo's Skull (Going Outside)",
            object_id=0x99,
            warps_to=0x700,
            warps_from=0x70E,
            can_enter_warp_zone=(
                Warp.Banjo + Warp.Termite + Warp.Crocodile + Warp.Walrus + Warp.Bee
            ),
            warp_search_strings=[
        ...
        Warp(
            debug_name="MMM Mumbo's Skull (Coming Inside)",
            object_id=0x9A,
            warps_to=0x70E,
            warps_from=0x700,
            can_enter_warp_zone=(
        ...
        Warp(
            debug_name="MMM Gutter (Going Outside/Lower)",
            object_id=0x8F,
            warps_to=0x700,
            warps_from=0x70F,
            can_enter_warp_zone=Warp.Pumpkin,
            can_exit_from_room=Warp.Pumpkin,
            warp_search_strings=[
                "FFF9005802073306008F00000006D0F8",
            ],
        ),
        Warp(
            debug_name="MMM Gutter (Coming Inside/Lower)",
            object_id=0x80,
            warps_to=0x70F,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Pumpkin,
        ...
        Warp(
            debug_name="MMM Well (Going Outside/Lower)",
            object_id=0x11F,
            warps_to=0x700,
            warps_from=0x708,
            can_enter_warp_zone=Warp.Pumpkin,
        ...
        Warp(
            debug_name="MMM Well (Coming Inside/Lower)",
            object_id=0x11E,
            warps_to=0x708,
            warps_from=0x700,
            can_enter_warp_zone=Warp.Pumpkin,
        ...
        Warp(
            debug_name="MMM Loggo (Going Outside)",
            object_id=0x120,
            warps_to=0x704,
            warps_from=0x710,
            can_enter_warp_zone=Warp.Pumpkin,
            can_exit_from_room=Warp.Pumpkin,
            warp_search_strings=["001C017505A447060120000000001A3F"],
        ),
    ],
    "Rusty Bucket Bay": [
        ...
        #             ]),
        Warp(
            debug_name="RBB Big Fish Warehouse (Coming Inside/Top)",
            object_id=0xA7,
            warps_to=0x801,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="RBB Big Fish Warehouse (Coming Inside/Side)",
            object_id=0xB9,
            warps_to=0x801,
            warps_from=0x800,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="RBB Boat Room (Going Outside)",
            object_id=0xB3,
            warps_to=0x800,
            warps_from=0x802,
            can_enter_warp_zone=Warp.Banjo,
        ...
        # Can't Find Warp?
        Warp(
            debug_name="RBB Boat Room (Coming Inside)",
            object_id=0xA8,
            warps_to=0x802,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        # Can't Find Warp?
        Warp(
            debug_name="RBB Left Blue Container (Going Outside)",
            object_id=0xB4,
            warps_to=0x800,
            warps_from=0x803,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Left Blue Container (Coming Inside)",
            object_id=0xA9,
            warps_to=0x803,
            warps_from=0x800,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Middle Blue Container (Going Outside)",
            object_id=0xB5,
            warps_to=0x800,
            warps_from=0x804,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Middle Blue Container (Coming Inside)",
            object_id=0xAA,
            warps_to=0x804,
            warps_from=0x800,
            can_exit_from_room=(Warp.Banjo + Warp.Bee),
            warp_search_strings=[
                "FE73FDCCF2575B8600AA000000000000",
            ],
        ),
        Warp(
            debug_name="RBB Right Blue Container (Going Outside)",
            object_id=0xB6,
            warps_to=0x800,
            warps_from=0x805,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Right Blue Container (Coming Inside)",
            object_id=0xAB,
            warps_to=0x805,
            warps_from=0x800,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Kitchen (Going Outside)",
            object_id=0xAF,
            warps_to=0x800,
            warps_from=0x806,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Kitchen (Coming Inside)",
            object_id=0xA3,
            warps_to=0x806,
            warps_from=0x800,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Navigation Room (Going Outside)",
            object_id=0xB0,
            warps_to=0x800,
            warps_from=0x807,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Navigation Room (Coming Inside)",
            object_id=0xA4,
            warps_to=0x807,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="RBB Captain's Room (Going Outside)",
            object_id=0xAC,
            warps_to=0x800,
            warps_from=0x808,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Captain's Room (Coming Inside)",
            object_id=0xA0,
            warps_to=0x808,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="RBB Middle Pipe (Going Outside)",
            object_id=0xB1,
            warps_to=0x800,
            warps_from=0x809,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Middle Pipe (Coming Inside)",
            object_id=0xA5,
            warps_to=0x809,
            warps_from=0x800,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Bedroom (Going Outside)",
            object_id=0xAD,
            warps_to=0x800,
            warps_from=0x80A,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Bedroom (Coming Inside)",
            object_id=0xA1,
            warps_to=0x80A,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="RBB Engine Room (Going Outside/Main)",
            object_id=0xB2,
            warps_to=0x800,
            warps_from=0x80B,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Engine Room (Coming Inside/Main)",
            object_id=0xA6,
            warps_to=0x80B,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="RBB Engine Room (Coming Outside/Button)",
            object_id=0xAE,
            warps_to=0x800,
            warps_from=0x80C,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Engine Room (Going Inside/Button)",
            object_id=0xA2,
            warps_to=0x80C,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="RBB Boombox Room (Going Outside)",
            object_id=0xB7,
            warps_to=0x800,
            warps_from=0x80D,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Boombox Room (Coming Inside)",
            object_id=0xB8,
            warps_to=0x80D,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="RBB Anchor Room (Going Outside)",
            object_id=0x11C,
            warps_to=0x800,
            warps_from=0x80E,
            warp_search_strings=[
        ...
        Warp(
            debug_name="RBB Anchor Room (Coming Inside)",
            object_id=0x11D,
            warps_to=0x80E,
            warps_from=0x800,
            can_enter_warp_zone=Warp.Banjo,
    ...
    "Click Clock Wood - Spring": [
        Warp(
            debug_name="CCW Spring Mumbo's Skull (Going Outside)",
            object_id=0xDF,
            warps_to=0x900,
            warps_from=0x901,
            can_enter_warp_zone=(
        ...
        Warp(
            debug_name="CCW Spring Mumbo's Skull (Coming Inside)",
            object_id=0xE3,
            warps_to=0x901,
            warps_from=0x900,
            can_enter_warp_zone=(
        ...
        Warp(
            debug_name="CCW Spring Nabnut's Door (Going Outside)",
            object_id=0xEB,
            warps_to=0x900,
            warps_from=0x902,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Spring Nabnut's Door (Coming Inside)",
            object_id=0xE7,
            warps_to=0x902,
            warps_from=0x900,
            can_enter_warp_zone=(Warp.Banjo + Warp.Bee),
        ...
        Warp(
            debug_name="CCW Spring Nabnut's Window (Going Outside)",
            object_id=0x127,
            warps_to=0x900,
            warps_from=0x903,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Spring Nabnut's Window (Coming Inside)",
            object_id=0x123,
            warps_to=0x903,
            warps_from=0x900,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Spring Whipcrack Room (Going Outside)",
            object_id=0x58,
            warps_to=0x900,
            warps_from=0x904,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Spring Whipcrack Room (Coming Inside)",
            object_id=0x12,
            warps_to=0x904,
            warps_from=0x900,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Spring Zubba Hive (Going Outside)",
            object_id=0x110,
            warps_to=0x900,
            warps_from=0x905,
            can_enter_warp_zone=Warp.Bee,
            can_exit_from_room=Warp.Bee,
            warp_search_strings=[
                "00000258092D750601100000000017CF",
            ],
        ),
        Warp(
            debug_name="CCW Spring Zubba Hive (Coming Inside)",
            object_id=0x10D,
            warps_to=0x905,
            warps_from=0x900,
            can_enter_warp_zone=Warp.Bee,
    ...
    "Click Clock Wood - Summer": [
        Warp(
            debug_name="CCW Summer Mumbo's Skull (Going Outside)",
            object_id=0xE0,
            warps_to=0x1000,
            warps_from=0x1001,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Summer Mumbo's Skull (Coming Inside)",
            object_id=0xE4,
            warps_to=0x1001,
            warps_from=0x1000,
            keep_in_same_world=True,
        ...
        Warp(
            debug_name="CCW Summer Zubba Hive (Going Outside)",
            object_id=0x111,
            warps_to=0x1000,
            warps_from=0x1002,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Summer Zubba Hive (Coming Inside)",
            object_id=0x10E,
            warps_to=0x1002,
            warps_from=0x1000,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Summer Nabnut's Door (Going Outside)",
            object_id=0xEC,
            warps_to=0x1000,
            warps_from=0x1003,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Summer Nabnut's Door (Coming Inside)",
            object_id=0xE8,
            warps_to=0x1003,
            warps_from=0x1000,
            can_enter_warp_zone=(Warp.Banjo + Warp.Bee),
        ...
        Warp(
            debug_name="CCW Summer Nabnut's Window (Going Outside)",
            object_id=0x128,
            warps_to=0x1000,
            warps_from=0x1004,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Summer Nabnut's Window (Coming Inside)",
            object_id=0x124,
            warps_to=0x1004,
            warps_from=0x1000,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Summer Whipcrack Room (Going Outside)",
            object_id=0x59,
            warps_to=0x1000,
            warps_from=0x1005,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Summer Whipcrack Room (Coming Inside)",
            object_id=0x13,
            warps_to=0x1005,
            warps_from=0x1000,
            can_enter_warp_zone=Warp.Banjo,
    ...
    "Click Clock Wood - Fall": [
        Warp(
            debug_name="CCW Fall Mumbo's Skull (Going Outside)",
            object_id=0xE1,
            warps_to=0x1100,
            warps_from=0x1101,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Fall Mumbo's Skull (Coming Inside)",
            object_id=0xE5,
            warps_to=0x1101,
            warps_from=0x1100,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Fall Zubba Hive (Going Outside)",
            object_id=0x112,
            warps_to=0x1100,
            warps_from=0x1102,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Fall Zubba Hive (Coming Inside)",
            object_id=0x10F,
            warps_to=0x1102,
            warps_from=0x1100,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Fall Nabnut's Door (Going Outside)",
            object_id=0xED,
            warps_to=0x1100,
            warps_from=0x1103,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Fall Nabnut's Door (Coming Inside)",
            object_id=0xE9,
            warps_to=0x1103,
            warps_from=0x1100,
            can_enter_warp_zone=(Warp.Banjo + Warp.Bee),
        ...
        Warp(
            debug_name="CCW Fall Nabnut's Window (Going Outside)",
            object_id=0x129,
            warps_to=0x1100,
            warps_from=0x1104,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Fall Nabnut's Window (Coming Inside)",
            object_id=0x125,
            warps_to=0x1104,
            warps_from=0x1100,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Fall Nabnut's Attic 1 (Going Outside)",
            object_id=0x2D,
            warps_to=0x1100,
            warps_from=0x1105,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Fall Nabnut's Attic 1 (Coming Inside)",
            object_id=0x2A,
            warps_to=0x1105,
            warps_from=0x1100,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Fall Whipcrack Room (Going Outside)",
            object_id=0x5A,
            warps_to=0x1100,
            warps_from=0x1106,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Fall Whipcrack Room (Coming Inside)",
            object_id=0x14,
            warps_to=0x1106,
            warps_from=0x1100,
            keep_in_same_world=True,
    ...
    "Click Clock Wood - Winter": [
        Warp(
            debug_name="CCW Winter Mumbo's Skull (Going Outside)",
            object_id=0xE2,
            warps_to=0x1200,
            warps_from=0x1201,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Winter Mumbo's Skull (Coming Inside)",
            object_id=0xE6,
            warps_to=0x1201,
            warps_from=0x1200,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Winter Nabnut's Window (Going Outside)",
            object_id=0x12A,
            warps_to=0x1200,
            warps_from=0x1202,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Winter Nabnut's Window (Coming Inside)",
            object_id=0x126,
            warps_to=0x1202,
            warps_from=0x1200,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Winter Nabnut's Attic 1 (Going Outside)",
            object_id=0x2C,
            warps_to=0x1200,
            warps_from=0x1203,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Winter Nabnut's Attic 1 (Coming Inside)",
            object_id=0x2B,
            warps_to=0x1203,
            warps_from=0x1200,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Winter Nabnut's Attic 2 (Going Outside)",
            object_id=0x2E,
            warps_to=0x1200,
            warps_from=0x1204,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Winter Nabnut's Attic 2 (Coming Inside)",
            object_id=0x29,
            warps_to=0x1204,
            warps_from=0x1200,
            can_enter_warp_zone=Warp.Banjo,
        ...
        Warp(
            debug_name="CCW Winter Whipcrack Room (Going Outside)",
            object_id=0x5B,
            warps_to=0x1200,
            warps_from=0x1205,
            warp_search_strings=[
        ...
        Warp(
            debug_name="CCW Winter Whipcrack Room (Coming Inside)",
            object_id=0x15,
            warps_to=0x1205,
            warps_from=0x1200,
            can_enter_warp_zone=Warp.Banjo,
    ...
    "Spiral Mountain": [
        Warp(
            debug_name="SM Banjo's House (Going Inside)",
            object_id=0x118,
            warps_to=0x1300,
            warps_from=0x1301,
            warp_search_strings=[
        ...
        Warp(
            debug_name="SM Banjo's House (Coming Outside)",
            object_id=0x119,
            warps_to=0x1301,
            warps_from=0x1300,
            warp_search_strings=[
        ...
        Warp(
            debug_name="SM Grunty's Lair (Going Inside)",
            object_id=0x12D,
            warps_to=0x1302,
            warps_from=0x1300,
            keep_in_same_setup=True,
    ...
    def _shuffle_warps_within_list(self, warps, shuffle_type):
        ...
        while warps_to_main:
            ...
            for warp in warps_to_main:
                if (
                    (
                        (randomized_warp.can_enter_warp_zone & warp.can_exit_from_room)
                        > 0
                    )
                    and (
                        (
                            (randomized_warp.can_enter_warp_zone >= 32)
                            and (warp.can_enter_warp_zone >= 32)
                        )
                        or (
                            randomized_warp.can_enter_warp_zone
                            == warp.can_enter_warp_zone
                        )
                    )
                    and (warp.warps_from != randomized_warp.warps_to)
                    and (warp.warps_to != randomized_warp.warps_from)
                ):
                    ...
                    elif (shuffle_type == "Global") and (
                        randomized_warp.keep_in_same_world or warp.keep_in_same_world
                    ):
                        if (randomized_warp.warps_from // 0x100) == (
                            warp.warps_from // 0x100
                        ):
                            selectable_temp_warps.append(warp)
                    else:
                        selectable_temp_warps.append(warp)
            if selectable_temp_warps:
                ...
                for warp in reversed(warps_from_main):
                    if (
                        (randomized_warp.can_enter_warp_zone & warp.can_enter_warp_zone)
                        > 0
                    ) and (
                        (randomized_warp.can_exit_from_room & warp.can_exit_from_room)
                        > 0
                    ):  # and (randomized_warp.warps_from == warp.warps_to)):
            ...
            self._randomized_warp_dict[randomized_warp] = (
                randomized_warp.old_warp_search_strings
            )
            self._randomized_warp_cheat_sheet_dict[randomized_warp.name] = (
                randomized_warp.warps_name
            )

    def _randomize_by_world(self, level_name):
        self._shuffle_warps_within_list(
            self._level_warp_dict[level_name], shuffle_type="Within World"
        )
...
if __name__ == "__main__":
    ...
    #             print(f"{warp_obj.old_object_id} -> {warp_obj.new_object_id}")
        ...
        within_world_warps_obj._randomize_by_game(
            [
                "Mumbo's Mountain",
                "Treasure Trove Cove",
                "Clanker's Cavern",
