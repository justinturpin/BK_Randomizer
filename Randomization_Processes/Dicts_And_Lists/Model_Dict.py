...
model_dict = {
    "BK_Model1": {
        "Banjo_Fur": {
            ...
            "Color_Check": lambda red, green, blue, alpha: (
                (
                    (red > 0x25)
                    and (red > (2.2 * green))
                    and (red < (3 * green))
        ...
        "Kazooie_Feathers": {
            ...
            "Color_Check": lambda red, green, blue, alpha: (red > 0x50)
            and (red > (2.6 * green))
            and (blue < 0x5)
            and (alpha == 0xFF),
            "Texture": {
        ...
        "Kazooie_Spots": {
            ...
            "Color_Check": lambda red, green, blue, alpha: (red > 0xC8)
            and (red > (1.1 * green))
            and (red < (2.5 * green))
            and (red > (10 * blue))
            and (alpha == 0xFF),
        ...
        "Backpack": {
            ...
            "Color_Check": lambda red, green, blue, alpha: (blue > 0x25)
            and (blue > (1.1 * green))
            and (blue > (1.1 * red))
            and (alpha == 0xFF),
        },
