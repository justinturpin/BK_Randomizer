...
enemy_id_dict: dict[str, dict[str, list[str]]] = {
    "Global": {
        "Ground": [
            "190C0004",  # Bull
            "190C0005",  # Ticker
...
additional_search_enemy_id_dict: dict[str, list[str]] = {
    "Ground": [
...
for area in ["Lobby", "Spring", "Summer", "Fall", "Winter"]:
    for enemy_type in enemy_id_dict[f"Click Clock Wood - {area}"]:
        enemy_id_dict["Click Clock Wood"][enemy_type] = enemy_id_dict[
            f"Click Clock Wood - {area}"
        ][enemy_type]
