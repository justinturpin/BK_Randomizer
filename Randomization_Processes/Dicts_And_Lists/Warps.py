...
bottles_world_warp_dict = {
    ...
    "GV": {
        ...
        "Possible_Bottles": {
            ...
            "King_Sandybutt_1_up": [
                ["Eggs", "Turbo_Talon_Trot", "Beak_Buster"],
                ["Eggs", "Talon_Trot", "Beak_Buster"],
            ],
    ...
    "CCW": {
        "Prior_Moves": ["Talon_Trot", "Beak_Buster"],
        "In_World_Moves": [],
        "Available_Slots": 3,
        "Possible_Bottles": {
            "Spring_Whipcrack_Room_Floor": [["Talon_Trot", "Shock_Jump_Pad"]],
            "Summer_Grass_1_up": [],
            "Winter_Sir_Slush": [["Fly", "Beak_Bomb"]],
            "Yellow_Jinjo": [],
            "Red_Jinjo": [["Talon_Trot"]],
        },
    },
}
