...
warp_dict = {
    ...
    "Mad Monster Mansion": {
        ...
        "Unsafe_Transform": {
            "MMM_Outside_Loggo": ["001C017505A447060120000000001A3F"],
    ...
    "Click Clock Wood": {
        "Safe": {
            "CCW_Spring_Warp_To_Lobby": ["000000771E917D0600D700000000ABF3"],
        },
        "Unsafe": {
            ...
            "CCW_Lobby_Spring_Entrance": ["000000610EF14B0600DB000000000000"],
            "CCW_Lobby_Summer_Entrance": ["F10F4B0600DD00000000000000800040"],
            "CCW_Lobby_Fall_Entrance": ["00000061F10F4B0600DD000000000000"],
            "CCW_Lobby_Winter_Entrance": ["0EF100DD00004B0600DA000000000000"],
            "CCW_Spring_Outside_Mumbo_Skull": [
                "E53402D000004B0600E30000000E1592",
            ],
            "CCW_Spring_Outside_Nabnut_Door": [
