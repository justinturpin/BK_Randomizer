bottles_world_warp_dict = {
    "Mumbo's Mountain": {
        ...
        "Flagged_Object_Flags": {
            ...
            ### EMPTY HONEYCOMBS ###
            # Alcove Empty Honeycomb
            "03D2020E0694": {
                "Type": None,
                "Requirements": [[]],
            },
            # Juju Empty Honeycomb
            "10ED0B6CFA2B": {
                "Type": None,
                "Requirements": [["Eggs"]],
            },
    ...
    "Treasure Trove Cove": {
        ...
        "Flagged_Object_Flags": {
            ...
            # Shock_Jump_Pad Alcove
            "0B110863F8F1": {
                "Type": None,
                "Requirements": [["Shock_Jump_Pad"], ["Fly"]],
            },
            # Backside Alcove
            "EBCD0584F086": {
                "Type": None,
            ...
            ### EMPTY HONEYCOMB ###
            # Underwater Empty Honeycomb
            "EF4B00210068": {
                "Type": None,
                "Requirements": [[]],
            },
            # Crate Empty Honeycomb
            "2106036FF596": {
                "Type": None,
                "Requirements": [[]],
            },
            ...
            # Lockup Mumbo Token 1
            "F59D096CE84C": {
                "Type": None,
                "Requirements": [[]],
            },
            # Lockup Mumbo Token 2
            "F5AE096CE7AD": {
                "Type": None,
                "Requirements": [[]],
            },
            # Crow's Nest Mumbo Token
            "FEFE080603B5": {
                "Type": None,
                "Requirements": [[]],
            },
            ...
            # Near Treasure Mumbo Token
            "19410265FF12": {
                "Type": None,
                "Requirements": [[]],
            },
            # Underwater Crater Mumbo Token
            "ECD104ABFBCA": {
                "Type": None,
                "Requirements": [[]],
            },
            # Shock_Jump_Pad Mumbo Token
            "09C708BD0BA0": {
                "Type": None,
                "Requirements": [["Fly"], ["Shock_Jump_Pad"]],
            },
            # Behind Nipper
            "E626022B11FB": {
                "Type": None,
    ...
    "Bubblegloop Swamp": {
        ...
        "Flagged_Object_Flags": {
            ...
            "*Croctus": {
                "Type": "Jiggy",
                "Requirements": [
                    ["Beak_Buster", "Shock_Jump_Pad", "Eggs", "Talon_Trot"]
                ],
            },
            # Gold Flibbits
            "*Gold Flibbits": {
            ...
            "*BGS Egg": {
                "Type": "Jiggy",
                "Requirements": [["Shock_Jump_Pad", "Beak_Buster"]],
            },
            # Central Timer
            "*Central Timer": {
                "Type": "Jiggy",
            ...
            "*Maze Timer": {
                "Type": "Jiggy",
                "Requirements": [["Wading_Boots", "Beak_Buster"]],
            },
            # Mr Vile
            "*Mr Vile": {
                "Type": "Jiggy",
                "Requirements": [["Wading_Boots", "Crocodile"]],
            },
            # Jinjos
            "*Jinjos": {
                "Type": "Jiggy",
    ...
    "Freezeezy Peak": {
        ...
        "Flagged_Object_Flags": {
            ...
            "*Boggy 1: Return Sled": {
                "Type": "Jiggy",
                "Requirements": [["Talon_Trot"], ["Fly"]],
            },
            # Boggy 2: Walrus Race
            "*Boggy 2: Walrus Race": {
                "Type": "Jiggy",
                "Requirements": [["Talon_Trot", "Walrus"], ["Fly", "Walrus"]],
            },
            # Boggy 3: BK Race
            "*Boggy 3: BK Race": {
                "Type": "Jiggy",
                "Requirements": [
                    ["Talon_Trot", "Shock_Jump_Pad", "Walrus", "Turbo_Talon_Trot"],
                    ["Fly", "Walrus", "Turbo_Talon_Trot"],
                ],
            },
            # Snowman Buttons
            "*Snowman Buttons": {
                "Type": "Jiggy",
                "Requirements": [["Fly", "Beak_Bomb"]],
            },
            # Christmas Tree
            "*Christmas Tree": {
                "Type": "Jiggy",
                "Requirements": [["Eggs", "Fly"]],
            },
            # Sir Slush
            "*Sir Slush": {
                "Type": "Jiggy",
            ...
            # Sir Slush Lonely Island
            "057F00120AE5": {
                "Type": None,
                "Requirements": [["Fly", "Beak_Bomb"]],
            },
            # Under Sir Slush Near Wozza
            "EE7300D2FCBB": {
                "Type": None,
                "Requirements": [["Fly", "Beak_Bomb"]],
            },
    ...
    "Gobi's Valley": {
        ...
        "Flagged_Object_Flags": {
            ...
            "*Grabba": {
                "Type": "Jiggy",
                "Requirements": [["Running Shoes"], ["Fly", "Beak_Bomb"]],
            },
            # Matching Puzzle
            "*Matching Puzzle": {
                "Type": "Jiggy",
            ...
            # Below King Sandybutt's Pyramid
            "007D0217FC73": {
                "Type": None,
                "Requirements": [[]],
            },
            # Above King Sandybutt's Pyramid
            "00430DA20190": {
                "Type": None,
                "Requirements": [["Eggs"], ["Fly"]],
            },
            # Water Pyramid Lower Entrance
            "FF1B0B1BF3DB": {
                "Type": None,
                "Requirements": [[]],
            },
    ...
    "Mad Monster Mansion": {
        ...
        "Flagged_Object_Flags": {
            ...
            "*Motzand": {
                "Type": "Jiggy",
                "Requirements": [["Beak_Buster", "Turbo_Talon_Trot", "Shock_Jump_Pad"]],
            },
            # Flower Pots
            "*Flower Pots": {
                "Type": "Jiggy",
            ...
            "*MMM Jinjos": {
                "Type": "Jiggy",
                "Requirements": [["Beak_Buster", "Shock_Jump_Pad", "Turbo_Talon_Trot"]],
            },
            ### EMPTY HONEYCOMB ###
            # Church
            "FFC91458095B": {
                "Type": None,
                "Requirements": [
                    ["Beak_Buster", "Turbo_Talon_Trot", "Shock_Jump_Pad", "Fly"]
                ],
            },
            # Pumpkin Empty Honeycomb
            "FFD9FFB80036": {
                "Type": None,
                "Requirements": [["Pumpkin"]],
            },
            ...
            "F50C05C3FAA9": {
                "Type": None,
                "Requirements": [["Talon_Trot"], ["Pumpkin"]],
            },
            # Maze (Pumpkin)
            "F9B00000FBE6": {
                "Type": None,
            ...
            "FFFD0230FAFE": {
                "Type": None,
                "Requirements": [["Beak_Buster", "Turbo_Talon_Trot"]],
            },
            # Tumblar Roof
            "070B0367EF58": {
                "Type": None,
...
click_clock_wood_closed_dict = {
    "Possible_Bottles": {
        ...
        "Spring_Whipcrack_Room_Floor_1_Up": [
            ["Beak_Buster", "Talon_Trot", "Shock_Jump_Pad"]
        ],
        ...
        "Fall_Orange_Jinjo": [
            ["Beak_Buster", "Talon_Trot", "Shock_Jump_Pad", "Wading_Boots", "Beak_Bomb"]
        ],
        "Fall_Acorn_Ledge": [
            ["Beak_Buster", "Talon_Trot", "Shock_Jump_Pad", "Wading_Boots", "Beak_Bomb"]
        ],
        "Winter_Sir_Slush": [
            ["Beak_Buster", "Talon_Trot", "Shock_Jump_Pad", "Fly", "Beak_Bomb"]
        ],
    },
    "Flagged_Object_Flags": {
        ###### SPRING ######
        ...
        "FFCD1DE50C5C": {
            "Type": None,
            "Requirements": [
                ["Beak_Buster", "Talon_Trot", "Bee"],
                ["Beak_Buster", "Wading_Boots", "Bee"],
            ],
        },
        # Whipcrack Room
        "FFC500240103": {
        ...
        "F0F105940EEC": {
            "Type": None,
            "Requirements": [
                ["Beak_Buster", "Talon_Trot", "Shock_Jump_Pad", "Wonderwing"]
            ],
        },
        # Branches
        "EDD60AF0FB2C": {
...
click_clock_wood_open_dict = {
    "Possible_Bottles": {
        ...
        "Fall_Acorn_Ledge": [
            ["Talon_Trot", "Shock_Jump_Pad", "Wading_Boots", "Beak_Bomb"]
        ],
...
extra_flagged_object_flags = {
    "Gruntilda's Lair": {
        ...
        "FFFA00000002": {
            "Type": None,
            "Requirements": [
                ["Beak_Buster", "Shock_Jump_Pad", "Bubblegloop Swamp", "Gobi's Valley"],
                [
                    "Beak_Buster",
                    "Shock_Jump_Pad",
                    "Bubblegloop Swamp",
        ...
        "103B0948199C": {
            "Type": None,
            "Requirements": [
                ["Beak_Buster", "Turbo_Talon_Trot", "Fly", "Freezeezy Peak"]
            ],
        },
        ...
        "FAF601FDFCED": {
            "Type": None,
            "Requirements": [
                ["Beak_Buster", "Shock_Jump_Pad", "Gobi's Valley"],
                ["Beak_Buster", "Shock_Jump_Pad", "Freezeezy Peak"],
                ["Beak_Buster", "Shock_Jump_Pad", "Mad Monster Mansion"],
                ["Beak_Buster", "Shock_Jump_Pad", "Rusty Bucket Bay"],
                ["Beak_Buster", "Shock_Jump_Pad", "Click Clock Wood"],
            ],
        },
        ...
        "000D0352F680": {
            "Type": None,
            "Requirements": [
                ["Beak_Buster", "Treasure Trove Cove"],
                ["Clanker's Cavern"],
                ["Beak_Buster", "Bubblegloop Swamp"],
                ["Beak_Buster", "Freezeezy Peak"],
                ["Beak_Buster", "Gobi's Valley"],
                ["Beak_Buster", "Mad Monster Mansion"],
                ["Beak_Buster", "Rusty Bucket Bay"],
                ["Beak_Buster", "Click Clock Wood"],
            ],
        },
        # Sarcophagus
        "FA310000FC78": {
        ...
        "104805CD186B": {
            "Type": None,
            "Requirements": [
                ["Shock_Jump_Pad", "Freezeezy Peak"],
                ["Shock_Jump_Pad", "Gobi's Valley"],
                ["Shock_Jump_Pad", "Mad Monster Mansion"],
                ["Shock_Jump_Pad", "Rusty Bucket Bay"],
                ["Shock_Jump_Pad", "Click Clock Wood"],
            ],
        },
        # Coffin Room
        "05BB00FA0000": {
